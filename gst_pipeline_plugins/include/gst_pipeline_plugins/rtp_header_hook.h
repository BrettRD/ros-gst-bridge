#ifndef GST_PIPELINE_PLUGINS__RTP_HEADER_HOOK_H_
#define GST_PIPELINE_PLUGINS__RTP_HEADER_HOOK_H_
...
*/
class rtp_header_hook : public gst_pipeline::plugin_base
{
public:
...
#endif  //GST_PIPELINE_PLUGINS__RTP_HEADER_HOOK_H_
