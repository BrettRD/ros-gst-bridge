...
{
  GstStateChangeReturn state_return = gst_element_set_state(GST_ELEMENT_CAST(pipeline_), GST_STATE_PAUSED);
...
void pause_srv::play_srv_cb(
  std_srvs::srv::Empty::Request::SharedPtr, std_srvs::srv::Empty::Response::SharedPtr)
{
  GstStateChangeReturn state_return = gst_element_set_state(GST_ELEMENT_CAST(pipeline_), GST_STATE_PLAYING);
  if (GST_STATE_CHANGE_FAILURE == state_return) {
